<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('Es necesario que verifiquemos tu cuenta antes de ingresar, vayamos a tu correo para confirmar tu cuenta a traves del enlace') }}
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400">
            {{ __('Se a reenviado un correo de confirmacion a tu cuenta') }}
        </div>
    @endif
